...
const whoopsieLevels = [
  ...
  {
    name: "My Bad",
    description: "Acknowledgment required, with a sincere apology.",
  },
  {
    name: "Whoops",
    description: "Significant mistake, effort needed to make amends.",
  },
  {
    name: "Yikes",
    description: "Serious error, substantial effort to repair trust.",
  },
  {
    name: "Oof",
    description: "Major blunder, repercussions affecting multiple aspects.",
  },
  {
    name: "Uh-oh, Big Time",
    description: "Serious mistake with lasting consequences.",
  },
  {
    name: "Major Whoopsie",
    description: "Widespread offense or harm, lasting damage likely.",
  },
  {
    name: "Canceled",
    description: "Severe mistake leading to permanent consequences.",
  },
];
